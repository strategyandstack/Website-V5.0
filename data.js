export const salesArchitectureData = {
  "meta": {
    "name": "Strategy & Stack",
    "version": "4.0",
    "tagline": "Build Your Sales Engine Without Building a Sales Team",
    "website": "StrategyandStack.com",
    "powered_by": ["LinkedIn Success Formula", "AuthGen"]
  },
  "hero": {
    "headline": "Build Your Sales Engine Without Building a Sales Team",
    "subheadline": "Sales Architecture: Five modular blueprints that install lead generation systems using automation, AI, and battle-tested processes—delivering results that would traditionally require 3x to 5x more staff.",
  ...
  "blueprints": [
    {
      ...
      "timeline": "2-3 weeks from kickoff to fully warmed inboxes",
      "price": "$8,125",
      "deliverables": [
    ...
    },
    {
      ...
      "timeline": "System live within 1-2 weeks, runs for 90 days",
      "price": "$4,875",
      "deliverables": [
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "Most teams invest between $12k and $21k to install their sales system. Most clients start with Starter or Growth, then upgrade to Full Stack within 30-60 days once the system is live."
    }
  ],
  "social_proof": {
    "stats": [
      {"metric": "Time Savings", "value": "70", "suffix": "%"},
      {"metric": "Faster Than DIY", "value": "3", "suffix": "x"},
